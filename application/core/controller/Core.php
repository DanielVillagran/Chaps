...
class Core {
	...
	public static $pdf_footer = "Generado por el Sistema Paleteria/Neveria Chap's";
	public static $email_footer = "Correo generado Automaticamente por el Sistema Paleteria/Neveria Chap's v6";
