...
?>
    ...
    <body class="<?php if (isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])): ?>  skin-green-light sidebar-mini <?php else: ?>login-page<?php endif;?>" >
      <div class="wrapper">
        <!-- Main Header -->
...
echo $u->name . " " . $u->lastname;?>
	...
	if (Core::$user->kind == 1) {echo " (Administrador)";} else if (Core::$user->kind == 2) {echo " (Coordinador)";} else if (Core::$user->kind == 3) {echo " (Vendedor)";}
...
<!-- <?php if (Core::$user->kind == 1 || Core::$user->kind == 2): ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="http://vmcomp.mx/" target="_blank">VMComp</a></strong>
  </footer>
  <?php else: ?>
    <?php if (isset($_GET["view"]) && $_GET["view"] == "clientaccess"): ?>
      <div class="login-box">
        <div class="login-logo">
          <a href="./"><img style="width: 80%;" src="logo.png"></a>
        </div><!-- /.login-logo -->
